...
namespace барбершоп
{
    public partial class УдалитьЗапись : Form
    {
        public УдалитьЗапись()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            OleDbCommand cmd = new OleDbCommand("DELETE FROM `барбершоп.accdb`.`записи` WHERE (`idЗаписи` = '"+textBox3.Text+"')",con);
            cmd.ExecuteNonQuery();
            con.Close();
